...
//
// Compilar (Linux):
//   g++ -O3 -std=c++20 -Wall -Wextra -o misp_ils misp_ils.cpp
//
// Ejecutar:
//   ./misp_ils ILS -i instancia.graph -t 60 --seed 42 --alpha 0.30 --perturb 3 --ls 2000 --verbose 1
//   unzip -p instancias.zip "ruta/archivo.graph" | ./misp_ils ILS -i - -t 60
